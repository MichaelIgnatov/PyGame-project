import pygame
from Sprites import player_group, all_sprites, box_group, player_image, tile_width, tile_height, stone_wall_group, \
    spike_group
...
class Player(pygame.sprite.Sprite):
    ...
    def update(self, *args):   # обработка столкновений с игровыми объектами
        if args:
